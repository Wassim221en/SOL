using SOL.Dashboard.Dashboard.Features.Employee.Commands.Add;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.Auth.Commands.CodeVerification;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.Auth.Commands.EmailConfirmed;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.Auth.Commands.ForgetPassword;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.Auth.Commands.Login;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.Auth.Commands.RefreshToken;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.Auth.Commands.ResetPassword;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.Delete;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.Modify;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.ModifyImage;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.ModifyMyPassword;
using SOL.Dashboard.Dashboard.Features.Employee.Commands.ModifyMyProfile;
using SOL.Dashboard.Dashboard.Features.Employee.Queries.GetAll;
using SOL.Dashboard.Dashboard.Features.Employee.Queries.GetAllName;
using SOL.Dashboard.Dashboard.Features.Employee.Queries.GetById;
using SOL.Dashboard.Dashboard.Features.Employee.Queries.GetEmployeeCardAsPdf;
using SOL.Dashboard.Dashboard.Features.Employee.Queries.GetEmployeesAsPdf;
using SOL.Dashboard.Dashboard.Features.Employee.Queries.GetMyProfile;
using MediatR;
